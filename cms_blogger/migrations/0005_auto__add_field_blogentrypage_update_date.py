...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogEntryPage.update_date'
        db.add_column('cms_blogger_blogentrypage', 'update_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)
        orm['cms_blogger.blogentrypage'].objects.update(update_date=F('publication_date'))

    def backwards(self, orm):
        # Deleting field 'BlogEntryPage.update_date'
        db.delete_column('cms_blogger_blogentrypage', 'update_date')
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 3, 2, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
