...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        Entry = orm['cms_blogger.blogentrypage']
        Entry.objects.filter(draft_id__isnull=True).update(draft_id=0)
        # Changing field 'BlogEntryPage.draft_id'
        db.alter_column('cms_blogger_blogentrypage', 'draft_id', self.gf('django.db.models.fields.CharField')(default=u'0', max_length=32))
        # Adding index on 'BlogEntryPage', fields ['draft_id']
        db.create_index('cms_blogger_blogentrypage', ['draft_id'])

    def backwards(self, orm):
        # Removing index on 'BlogEntryPage', fields ['draft_id']
        db.delete_index('cms_blogger_blogentrypage', ['draft_id'])

        # Changing field 'BlogEntryPage.draft_id'
        db.alter_column('cms_blogger_blogentrypage', 'draft_id', self.gf('django.db.models.fields.IntegerField')(null=True))
        Entry = orm['cms_blogger.blogentrypage']
        Entry.objects.filter(draft_id=u'0').update(draft_id=None)
    ...
    models = {
        ...
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'cms_blogger.blogentrypage': {
            ...
            'draft_id': ('django.db.models.fields.CharField', [], {'max_length': '32', 'db_index': 'True'}),
